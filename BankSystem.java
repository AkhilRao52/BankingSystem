...
private JMenuItem deposit, withdraw, delRec, search, searchName; //EditMenu Options.
private JMenuItem oneByOne, allCustomer; //View Menu Options.
private JMenuItem change, style, theme; //OptionMenu Options.
private JMenuItem close, closeAll; //Window Menu Options.
private JMenuItem content, keyHelp, about; //HelpMenu Options.
...
radio[i] = new JRadioButtonMenuItem (strings[i]); //BuildanArrayofLayoutsto Apply.
...
//SubMenu of Theme For Applying different Themes to Program By Building an Array of
Themes to Apply.
...
theme = new MetalThemeMenu ("Apply Theme", themes); //Putting the Themes in
ThemeMenu.
...
try {
printing = JOptionPane.showInputDialog (this, "Enter Account No. to Print Customer
Balance.\n" +
